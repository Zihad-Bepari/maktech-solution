    ...
    <div style="padding: 45px 35px 35px;">
      ...
      <div style="text-align: center;">
        ...
        <p style="color: #636E72; font-size: 15px; line-height: 1.6;">
          We received a request to reset your password. If this was you, click the button below to continue securely.
        </p>
      </div>

      <div style="text-align: center; margin: 35px 0;">
        <a href="${resetPasswordUrl}"
           style="display: inline-block; padding: 16px 45px; background: linear-gradient(135deg, #2E7D32 0%, #66BB6A 100%); color: #ffffff; text-decoration: none; border-radius: 12px; font-size: 17px; font-weight: 700; box-shadow: 0 8px 25px rgba(46, 125, 50, 0.25);">
          Reset Password
        </a>
      </div>
      ...
      <div style="background-color: #F1F8F4; border-radius: 15px; padding: 20px; border: 1px solid #D7EADF; text-align: center;">
        <p style="margin: 0; font-size: 14px; color: #555; line-height: 1.5;">
          <strong style="color: #2E7D32;">Security Notice:</strong> <br>
          This link will expire in <b style="color: #2E7D32;">10 minutes</b>. <br>
